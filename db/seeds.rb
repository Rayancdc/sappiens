...
EXPERIENCES = [
{price_cents: 5000 + rand(5000), image: 'Product-Manager.jpg', career: 'Product Management', description: 'Develops products by identifying potential products; conducting market research; generating product requirements; determining specifications,production timetables, pricing, and time-integrated plans forproduct introduction; developing marketing strategies,' },
{price_cents: 5000 + rand(5000), image: 'Growth Hacking 02.jpg', career: 'Growth Hacking', description: 'Growth hacking is a process of rapid experimentation across marketing funnel, product development, sales segments, and other areas of the business to identify the most efficient ways to grow a business.' },
{price_cents: 5000 + rand(5000), image: 'Web.jpg', career: 'Software Development', description: 'Web developers are the behind-the-scenes staff of the Internet: they design, create, and maintain websites. This involves writing code for the site, making layout decisions, considering the user interface, solving bugs/problems that emerge, and more. Many web developers are completely self-taught, while others have associate’s degrees or other formal certifications.' },
{price_cents: 5000 + rand(5000), image: 'Data Mining.jpg', career: 'Data Mining', description: 'Data mining is a process used by companies to turn raw data into useful information. By using software to look for patterns in large batches of data, businesses can learn more about their customers and develop more effective marketing strategies as well as increase sales and decrease costs.'},
{price_cents: 5000 + rand(5000), image: 'Data Science.jpg', career: 'Data Science', description: 'Data Science is an interdisciplinary field that uses scientific methods, processes, algorithms and systems to extract knowledge and insights from datain various forms, both structured and unstructured, similar to data mining.' },
{price_cents: 5000 + rand(5000), image: 'Computer User Support Specialist.jpg', career: 'Computer User Support Specialist', description: 'Computer user support specialists provide technical assistance to users by answering questions or resolving computer problems. This can be in person, through telephone or electronically (over chat messaging or email).' },
{price_cents: 5000 + rand(5000), image: 'Junior Data Analyst.jpg', career: 'Junior Data Analyst', description: 'Data is so hot right now that even entry-level analysts can make good money. Usually, junior analysts are the ones who conduct searches for data, create Excel spreadsheets and generate material for analysis, and present their findings to more senior colleagues, who handle the bulk of the more complex work.' },
{price_cents: 5000 + rand(5000), image: 'Computer Network Support Specialist.jpg', career: 'Computer Network Support Specialist', description: 'Computer network support specialists are responsible for keeping networks running smoothly. They test, troubleshoot, analyze, perform maintenance, and solve network problems. Usually you’ll need a certificate or associate’s degree to enter this career.' },
{price_cents: 5000 + rand(5000), image: 'Digital Marketer.png', career: 'Digital Marketer', description: 'Marketing via the Internet is one of the primary ways companies reach customers in the 21st century. Digital marketers enable this in a variety of ways: search engine optimization (SEO), search engine marketing (SEM), social media marketing, content marketing, e-mail marketing, and others. Often a digital marketer will specialize in only one or two of these areas.' },
{price_cents: 5000 + rand(5000), image: 'Cyber Security Analysts.jpg', career: 'Cyber Security Analysts', description: 'Many cyber security professionals who obtain four-year degrees head straight for the higher-up positions after graduating, leaving companies with a dearth of entry-level workers to handle a lot of the day-to-day. Junior cyber security analysts handle the “grunt work” like reviewing logs, controlling network settings, doing basic testing, etc.' },
{price_cents: 5000 + rand(5000), image: 'Multimedia Artist.jpg', career: 'Multimedia Artist', description: 'Multimedia artists often do have bachelor’s degrees, but they are not required. They work with various programs and technologies to develop animation, designs and special effects for movies, commercials, video games and other forms of electronic media.' },
{price_cents: 5000 + rand(5000), image: 'Web Developer.jpg', career: 'Web Developer', description: 'Web developers are the behind-the-scenes staff of the Internet: they design, create, and maintain websites. This involves writing code for the site, making layout decisions, considering the user interface, solving bugs/problems that emerge, and more. Many web developers are completely self-taught, while others have associate’s degrees or other formal certifications,' },
{price_cents: 5000 + rand(5000), image: 'Aerospace Engineer.jpg', career: 'Aerospace Engineer', description: 'You might expect something this advanced-sounding to require a four-year degree, but in reality most aerospace engineering and operations technicians only need an associate’s. They are responsible for operating and caring for the equipment used to build and test aircraft and spacecraft' },
{price_cents: 5000 + rand(5000), image: 'Information Technology Manager.jpg', career: 'Information Technology Manager', description: 'By working your way up from starter IT roles, you can eventually become an IT manager in a department. Managers often supervise teams, as well as being responsible for monitoring the company’s IT infrastructure. They are also the ones who develop the rules and protocol governing the use of company computers, data, and network access.' }
]
